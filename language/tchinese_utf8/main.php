...
define('_MD_TADUP_SELECTED_FILES', '將勾選的檔案：');
define('_MD_TADUP_SELECTED_DEL', '全部刪除');
define('_MD_TADUP_SELECTED_MOVETO', '搬移到：');
...
define('_MD_TADUP_FOLDER', '此資料夾');
define('_MD_TADUP_FOLDER_MOVE', '搬移到：');
define('_MD_TADUP_FOLDER_RENAME', '更名為：');
define('_MD_TADUP_FOLDER_ADD', '下建立新目錄：');
define('_MD_TADUP_FOLDER_DEL', '刪除');
...
define('_MD_TADUP_UPLOAD_ONE', '單檔上傳');
define('_MD_TADUP_JAVA_UPLOAD', '大檔上傳');
define('_MD_TADUP_BATCH_UPLOAD', '批次上傳');
define('_MD_TADUP_SELECT_FOLDER', '選擇目錄');
define('_MD_TADUP_SELECT_FILES', '選擇檔案');
define('_MD_TADUP_CREATE_NEW_FOLDER', '建立新目錄：');
define('_MD_TADUP_LINK', '連結檔案');
