...
function get_catalog_attribute($cat_sn = '', $check_power = false, $check_up_power = false)
{
    ...
    $admin = ($isAdmin) ? "<img src='images/stop.png' alt='" . sprintf(_MD_TADUP_FOLDER_DEL, $cat_title) . "' title='" . sprintf(_MD_TADUP_FOLDER_DEL, $cat_title) . "' border='0' height='16' width='16' hspace=4 align='absmiddle'><a href=\"javascript:delete_catalog_func({$cat_sn},{$cat['of_cat_sn']});\">" . sprintf(_MD_TADUP_FOLDER_DEL, $cat_title) .
                          '</a>' : '';
