  ...
  <div class="row">
    ...
    <div class="col-sm-9">
      ...
      <{if $op=="tad_uploader_cate_form"}>
        <{includeq file="$xoops_rootpath/modules/$xoops_dirname/templates/b4/op_tad_uploader_cate_form.tpl"}>
      <{elseif $files}>
            ...
            <tbody>
              <{foreach from=$files item=file}>
                <tr>
                  ...
                  <td><{$file.cf_size}></td>
                  <td>
                    <a href="javascript:delete_file_func(<{$file.cfsn}>,<{$file.cat_sn}>);" class="btn btn-sm btn-danger" id="del<{$file.cat_sn}>"><{$smarty.const._TAD_DEL}></a>
                    <a href="<{$xoops_url}>/modules/tad_uploader/uploads.php?cfsn=<{$file.cfsn}>" class="btn btn-sm btn-info" id="update<{$file.cat_sn}>"><{$smarty.const._TAD_EDIT}></a>
                  </td>
                </tr>
              <{/foreach}>
            </tbody>
