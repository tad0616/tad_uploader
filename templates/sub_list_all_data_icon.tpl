        ...
        <{if $folder_list|default:false}>
            <ul id="dir_sort" style="display:inline;">
                <{foreach from=$folder_list item=folder}>
                    <li id="tr_<{$folder.cat_sn}>" style="display:inline; margin:2px; width:<{$icon_width|default:''}>; height:130px; float:left;">
        ...
        <{if $files_list|default:false}>
            <ul id="sort" style="display:inline;">
                <{foreach from=$files_list item=file}>
                    <li id="tr_<{$file.cfsn}>" style="display:inline;margin:2px;width:<{$icon_width|default:''}>;height:130px;float:left;">
