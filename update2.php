...
// $dir=XOOPS_ROOT_PATH."/uploads/tad_uploader/user_6";
// if (is_dir($dir)) {
//     if ($dh = opendir($dir)) {
//         while (($file = readdir($dh)) !== false) {
//           list($cfsn)=explode('_',$file);
//           if(empty($files[$cfsn]))continue;
//           $oldname="{$dir}/{$file}";
//           $newname="{$dir}/{$cfsn}_{$files[$cfsn]}";
//           if(rename($oldname, $newname)){
//             echo "<div>{$newname} OK!</div>";
//           }else{
//             echo "<div style='color:red;'>{$newname} 失敗!</div>";
//           }
//         }
//         closedir($dh);
//     }
